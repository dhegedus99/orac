...
!-------------------------------------------------------------------------------
! Name: define_preprop_grid_ecmwf.F90
!
! Purpose:
! Use the high resolution ecmwf grid for preprocessing without interpolation.
!
! Description and Algorithm details:
! 1) Determine minimum and maximum lat/lon of image from the ECMWF lat/lon grid.
!
! Arguments:
! Name         Type   In/Out/Both Description
! ------------------------------------------------------------------------------
